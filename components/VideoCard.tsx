...
const VideoCard: NextPage<IProps> = ({ post }) => {
    ...
    return (
        <div className='flex flex-col boerder-b-2 border-gray-200 pb-6'>
            <div className=''>
                    ...
                    <div>
                        <Link href='/'>
                            <div className='flex items-center gap-2'>
                                ...
                                <p className='capitalize font-medium tex-ss text-gray-500 hidden md:block'>{post.postedBy.userName}</p>
